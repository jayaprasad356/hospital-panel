...
$db = getDbInstance();
$select = array('id', 'p_no', 'date', 'name', 'age', 'dob', 'gender', 'mobile', 'blood');
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo xss_clean($row['p_no']); ?></td>
                <td><?php echo xss_clean($row['date']); ?></td>
                <td><?php echo xss_clean($row['name']); ?></td>
                <td><?php echo xss_clean($row['age']); ?></td>
                <td><?php echo xss_clean($row['dob']); ?></td>
                <td><?php echo xss_clean($row['gender']); ?></td>
                <td><?php echo xss_clean($row['mobile']); ?></td>
                <td><?php echo xss_clean($row['blood']); ?></td>
                <td>
                    <a href="checkup.php?patient_id=<?php echo $row['id']; ?>&operation=view" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                    
                </td>
                <td>
                    <a href="admission.php?patient_id=<?php echo $row['id']; ?>&operation=view" class="btn btn-primary"><i class="glyphicon glyphicon-user"></i></a>
                    
                </td>
                <td>
                    <a href="edit_customer.php?patient_id=<?php echo $row['id']; ?>&operation=edit" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
