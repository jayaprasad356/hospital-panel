<fieldset>
    ...
    <div class="form-group">
        ...
        <input type="file" name="image" value="<?php echo htmlspecialchars($edit ? $customer['image'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="File" class="form-control" id="image">
        <p>uploaded file : <?php echo htmlspecialchars($edit ? $customer['image'] : '', ENT_QUOTES, 'UTF-8'); ?></p>
    </div>
