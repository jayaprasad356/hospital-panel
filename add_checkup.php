...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
    ...
    $last_id = $db->insert('checkup', $data_to_store);
    

    if($last_id)
    {
    	$_SESSION['success'] = "Checkup registered successfully!";
...
<div class="row">
     <div class="col-lg-12">
            <h2 class="page-header">Checkup Form</h2>
        </div>
        
</div>
    <form class="form" action="" method="post"  id="checkup_form" enctype="multipart/form-data">
    <?php $type = "file";?>
    
       <?php  include_once('./forms/checkup_form.php'); ?>
    </form>
</div>
